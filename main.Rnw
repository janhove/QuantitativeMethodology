...
knitr::opts_chunk$set(
  echo = FALSE, message = FALSE, fig.width = 1, fig.height = 0.95, fig.align = "center"
)
library(here)
library(tidyverse)
theme_set(theme_bw())
...
source(here::here("functions", "drawdag.R"))
@

\mainmatter

<<DAGs, child='01_DAGs.Rnw'>>=
@

<<randomisation, child='02_randomisation.Rnw'>>=
@

<<alternative, child='03_alternative.Rnw'>>=
@

<<stats, child='04_stats.Rnw'>>=
@

<<precision, child='05_precision.Rnw'>>=
@

<<within, child='06_pedagogical.Rnw'>>=
@

<<within, child='07_within.Rnw'>>=
@

<<quasi, child='08_quasi.Rnw'>>=
@

<<measurement, child='09_measurement.Rnw'>>=
@

<<qrp, child='10_qrp.Rnw'>>=
@
...
<<openscience, child='99_openscience.Rnw'>>=
@
